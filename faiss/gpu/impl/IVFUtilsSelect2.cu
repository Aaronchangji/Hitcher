...
void runPass2SelectLists(
        Tensor<float, 2, true>& heapDistances,  //qid, slice * k --> dis
        Tensor<idx_t, 2, true>& heapIndices,    //qid, slice * k --> embedid
        DeviceVector<void*>& listIndices,
        IndicesOptions indicesOptions,
        Tensor<idx_t, 2, true>& prefixSumOffsets,   //qid, probid --> offset
        Tensor<idx_t, 2, true>& ivfListIds,         //qid, probid --> cid
        int k,
    ...
    auto grid = dim3(ivfListIds.getSize(0));  //num queries
