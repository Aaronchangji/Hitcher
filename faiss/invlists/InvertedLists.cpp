...
// void ArrayInvertedLists::release_codes(size_t list_no, const uint8_t*) const {
//     assert(list_no < nlist);
//     codes[list_no].clear();
// }

// void ArrayInvertedLists::release_ids(size_t list_no, const idx_t*) const {
//     assert(list_no < nlist);
//     ids[list_no].clear();
// }
